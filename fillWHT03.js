...
/*
{
    ...
    "Radio Button0": "1)ยื่นปกติ (2) ยื่นเพิ่มเติมครั้งท",
    "Text1.17": "ื่นเพิ่มเติมครั้งท",
    "Radio Button10": "เดือนที่จ่ายเงินได้พึงประเมิน",
    "Text1.18": "พ.ศ.",
    "Radio Button2": "ยนำส่งภาษีตาม (1)	 มาตรา 3 เตรส (2)	 มาตรา 48 ทวิ (3) มาตรา 50",
...
async function fillWHT03() {
    console.log('fillWHT03');
    const formBuf = fs.readFileSync('./forms/04.WHT03.pdf');
    ...
    const fieldConfigs = {
        ...
        "Text1.23": {font: fNormal, fontSize: 12, alignment: TextAlignment.Right},
        "Text1.24": {font: fNormal, fontSize: 12, alignment: TextAlignment.Right},
        "Text2.1": {font: fNormal, fontSize: 12, alignment: TextAlignment.Right},
        "Text2.2": {font: fNormal, fontSize: 12, alignment: TextAlignment.Right},
        "Text2.3": {font: fNormal, fontSize: 12, alignment: TextAlignment.Right},
        "Text2.4": {font: fNormal, fontSize: 12, alignment: TextAlignment.Right},
        "Text2.23": {font: fNormal, fontSize: 12},
        "Text2.24": {font: fNormal, fontSize: 12},
        "Text2.25": {font: fNormal, fontSize: 12, alignment: TextAlignment.Center},
        "Text2.26": {font: fNormal, fontSize: 12, alignment: TextAlignment.Center},
        "Text2.27": {font: fNormal, fontSize: 12, alignment: TextAlignment.Center},
    };
    ...
    const outputPath = path.join(outputDir, '04.WHT03.pdf');
    form.flatten();
